...
# for root, _, fnames in os.walk('/home/jmyslinski/random_stuff/pbrt-v3-scenes/barcelona-pavilion/geometry'):
for root, _, fnames in os.walk('/Users/johnmyslinski/Documents/pbrt-v4-scenes/lte-orb/geometry'):
    for fname in fnames:
