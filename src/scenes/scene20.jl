function make_scene20(parsed_args::Dict)::Tuple{AbstractIntegrator, Scene}
    ...
    sphere_transform = Translate(Pnt3(0,40,0))
    sphere = Sphere(
        ShapeCore(
            sphere_transform,
    ...
    smoke_mi = MediumInterface(
        NanoVDBMedium(
            Scale(1.0, 1.0, 1.6) * RotateX(90.0),
    ...
    light = InfiniteLight(
        ...
        jmfp("/Users/johnmyslinski/Documents/pbrt-v4-scenes/explosion/textures/sky.exr"),
        true
    )
    push!(lights, light)
